...
public class GameManager : MonoBehaviour
{
        ...
        while (true)
        {
            switch (_currentState)
            {
                case StatesFoca.FueraDelMar:
                    Debug.Log("La foca est� fuera del mar.");
                ...
                case StatesFoca.MarProfundo:
                    Debug.Log("La foca est� en el mar profundo.");
                    yield return new WaitForSeconds(_timeForChangeOfState - 15f);
    ...
    {
        Debug.Log($"Advertencia: La foca cambiar� a {nuevoEstado} en 15 segundos.");
    }
